  ...
  return (
    <aside className="w-[320px] h-[900px] bg-[#240A44] text-white flex flex-col p-6">
      ...
      <div className="border-t border-[#450B7B] pt-4 space-y-2">
        <a
          href="mailto:vow.org8000@gmail.com?subject=Need%20Help%20-%20Vow%20Support"
          className="flex items-center gap-3 text-left px-3 py-2 rounded-xl 
        ...
        <a
          href="mailto:vow.org8000@gmail.com?subject=Contact%20Us%20-%20Vow%20Inquiry"
          className="flex items-center gap-3 text-left px-3 py-2 rounded-xl 
            hover:bg-[linear-gradient(90deg,#8231CC_0%,#29064A_83.93%)] text-gray-200 transition-all w-full"
        >
