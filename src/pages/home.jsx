  ...
  return (
    <>
      ...
      <section className="bg-white py-16 px-6 md:px-20 flex flex-col md:flex-row items-center justify-between">
        <div className="md:w-1/2 space-y-6">
          <h1 className="text-4xl font-bold text-000000">
            Your Ofice, Reimagined <span className="text-5C0EA4">– Virtually.</span>
          </h1>
          ...
          <div className="space-x-4">
            ...
            <button className="border-2 border-purple-600 text-purple-600 px-6 py-2 rounded-md font-semibold">
              Watch Demo
            </button>
          </div>
        </div>
      ...
      <section className="bg-gray-50 py-16 px-6 md:px-20 text-center">
        <h2 className="text-[48px] font-semibold mb-[96px] w-[1160px] h-[58px] text-[#0B0E13] [text-shadow:0_4px_4px_rgba(0,0,0,0.25)]">All Your Work In One Virtual Space</h2>
        <FeatureCards />
      </section>
